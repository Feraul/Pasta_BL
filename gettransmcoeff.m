...
totalmobility = getotalmobility(mobility,phasekey,row,posvertex);
...
if any(storeinv)
    ...
    averdens = ...
        getdensity(mobility,localmobvec,phasekey,getnsurn,posvertex);

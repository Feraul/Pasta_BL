...
function [newSw,orderintimestep,waterflowrate,oilflowrate,earlysw] = ...
    ...
    amountofneigvec,rtmd_storepos,rtmd_storeleft,rtmd_storeright,isonbound)
...
if any(producelem)
    ...
    for iprod = 1:length(producelem)
        ...
        oilflowrate = ...
            oilflowrate + fo(iprod)*flowresult(producelem(iprod));
        %Catch the water flow rate in producer well
        waterflowrate = ...
            waterflowrate + fw(iprod)*flowresult(producelem(iprod));
